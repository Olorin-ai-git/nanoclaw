...
<dict>
    ...
    <array>
        ...
        <string>${projectRoot}/dist/src/index.js</string>
    </array>
...
[Service]
Type=simple
ExecStart=${nodePath} ${projectRoot}/dist/src/index.js
...
describe('plist generation', () => {
  ...
  it('points to dist/src/index.js', () => {
    const plist = generatePlist(
      '/usr/local/bin/node',
      '/home/user/nanoclaw',
      '/home/user',
    );
    expect(plist).toContain('/home/user/nanoclaw/dist/src/index.js');
  });
...
describe('systemd unit generation', () => {
  ...
  it('sets correct ExecStart', () => {
    ...
    expect(unit).toContain(
      'ExecStart=/usr/bin/node /srv/nanoclaw/dist/src/index.js',
    );
  });
});
...
nohup ${JSON.stringify(nodePath)} ${JSON.stringify(projectRoot)}/dist/src/index.js >> ${JSON.stringify(projectRoot)}/logs/nanoclaw.log 2>> ${JSON.stringify(projectRoot)}/logs/nanoclaw.error.log &
